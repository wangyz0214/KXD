...
public class KoneListIterator<E> implements ListIterator<E> {
	/** 数据数组 **/
	 ...
	 */
	public KoneListIterator(E[] elements, int initialCursor, boolean looped) {
	 ...
	 *            则迭代器中的元素顺序为： 5 6 7 8 9 0 1 2 3 4
	 */
	public KoneListIterator(List<E> elements, int initialCursor, boolean looped) {
		cursor = initialCursor;
