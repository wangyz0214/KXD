...
public class ATMI32 {
	 ...
	 */
	public static native int allocInit();
	 ...
	 * @return
	 */
	public static native int getBufferSize(int bufHandle);
	 ...
	 * @param data
	 */
	public static native void setInitParams(int intiBufhandle, byte[] usrname,
	 ...
	 */
	public static native int tpinit(int intiBufhandle);
	 ...
	 *            int 分配好的缓冲区对象句柄
	 */
	public static native void tpfree(int bufhandle);
	 ...
	 *         ,TPEPROTO,TPESYSTEM,TPEOS]
	 */
	public static native int tpalloc(byte[] dataType, byte[] subType, int size);
	 ...
	 */
	public static native int Finit(int bufhandle);
	 ...
	 */
	public static native int Finit32(int bufhandle);
	 ...
	 *         TPESYSTEM,TPEOS]
	 */
	public static native int tpcall(byte[] service, int sendBuf, int sendLen,
			int recvBuf, int flags);
	 ...
	 *         TPESYSTEM,TPEOS]
	 */
	public static native int tpacall(byte[] service, int sendBuf, int sendLen,
			int flags);
	 ...
	 *         ,TPESYSTEM,TPEOS]
	 */
	public static native int tpgetrply(int acallHandle, int recvBuf, int flags);
	 ...
	 */
	public static native int tpconnect(byte[] service, int sendBuf,
	 ...
	 *         TPETIME,TPEBLOCK,TPGOTSIG,TPEPROTO,TPESYSTEM,TPEOS]
	 */
	public static native int tpsend(int conHandle, int sendBuf, int sendLen,
	 ...
	 *         TPETIME,TPEBLOCK,TPGOTSIG,TPEPROTO,TPESYSTEM,TPEOS]
	 */
	public static native int tprecv(int conHandle, int recvBuf, int flags,
			byte[] event);
	 ...
	 */
	public static native int Sget(int bufHandle, int srcoffset, int length,
	 ...
	 */
	public static native int Sset(int bufHandle, int dstoffset, byte[] data,
	 ...
	 */
	public static native int Fget(int bufHandle, int row, int col,
			byte[] data, int size);
	 ...
	 * @return >0 返回读出的数据长度;0 已到缓冲区尾；-1 错误,此时可通过 Ferror() 获取错误码
	 */
	public static native int Fget32(int bufHandle, int row, int col,
			byte[] data, int size);
	 ...
	 */
	public static native boolean Fset(int bufHandle, int row, int col,
			byte[] data);
	 ...
	 * @return >=0 成功；-1 错误,此时可通过 Ferror() 获取错误码
	 */
	public static native boolean Fset32(int bufHandle, int row, int col,
			byte[] data);
	 ...
	 * @return >=0 成功；-1 错误,此时可通过 Ferror() 获取错误码
	 */
	public static native boolean Fadd(int bufHandle, int row, byte[] data);
	 ...
	 * @return >=0 成功；-1 错误,此时可通过 Ferror() 获取错误码
	 */
	public static native boolean Fadd32(int bufHandle, int row, byte[] data);
	 ...
	 * @return >0 返回读出的数据长度;0 已到缓冲区尾；-1 错误,此时可通过 Ferror() 获取错误码
	 */
	public static native int Fnext(int bufHandle, int[] rowcol, byte[] data,
			int size);

	public static native int Foccur32(int bufHandle, int row);

	public static native int Foccur(int bufHandle, int row);
	 ...
	 * @return >0 返回读出的数据长度;0 已到缓冲区尾；-1 错误,此时可通过 Ferror() 获取错误码
	 */
	public static native int Fnext32(int bufHandle, int[] rowcol, byte[] data,
			int size);
	 ...
	 */
	public static native int Fprint(int bufHandle);
	 ...
	 * @return >=0 成功；-1 失败 此时可通过 Ferror() 获取错误码
	 */
	public static native int Fprint32(int bufHandle);
