...
public class AsyncTestTcpServer extends WorkServer {

	@Override
	public WorkTask createTask() {
		return new AsyncTestTcpWorkTask();
	}

	static public void main(String[] args) {
		new AsyncTestTcpServer()
				.start("TCPTESTSERVER", 8999, 1, 300, 1000, 300);
		new AsyncTestTcpServer()
				.start("TCPTESTSERVER", 9000, 1, 300, 1000, 300);
	}
}

class AsyncTestTcpWorkTask extends WorkTask {
