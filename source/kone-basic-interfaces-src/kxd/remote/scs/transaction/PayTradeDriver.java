...
abstract public class PayTradeDriver extends TradeDriver {
	 ...
	 *             付费超时时抛出
	 */
	abstract public void doPay(Request req, Result result) throws Throwable;
	...
	public boolean isNeedPayCancel(Request req, Result result, Throwable e) {
		return result.getPhase().compareTo(TradePhase.BEFORE_PAY) > 0
