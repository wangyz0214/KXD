...
public class CachedTermBusinessOpenClose extends CachedIntegerObject {
	...
	public IdableObject<Integer> createObject() {
		return new CachedTermBusinessOpenClose();
	}

	public void copyData(Object src) {
		super.copyData(src);
		if (!(src instanceof CachedTermBusinessOpenClose))
			return;
		CachedTermBusinessOpenClose d = (CachedTermBusinessOpenClose) src;
		configList.addAll(d.configList);
	}

	public CachedTermBusinessOpenClose() {
		super();
	}

	public CachedTermBusinessOpenClose(Integer id) {
		super(id);
	}
