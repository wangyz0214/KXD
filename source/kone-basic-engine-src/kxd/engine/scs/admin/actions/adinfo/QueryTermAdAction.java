...
public class QueryTermAdAction extends QueryAction {
	...
	protected String doGetTableOptionHtml() {
		return "<span> [</span><a onclick='javascript:expandAdList(arguments[0]);return false;' href='#'>查看</a> "
				+ " <a onclick='javascript:showAddAdDialog(arguments[0]);return false;' href='#'>添加</a><span>]</span>";
	}
