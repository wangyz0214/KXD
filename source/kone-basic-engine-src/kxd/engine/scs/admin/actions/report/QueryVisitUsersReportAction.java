...
public class QueryVisitUsersReportAction extends BaseReportAction {
	...
	protected String queryReport(HttpRequest request,
		...
		try {
			...
			table = bean.queryVisitUsersDayReport(orgid, t.getTime());
		} finally {
			context.close();
		}
		return null;
	...
	public int getEditRight() {
		return UserRight.VISITUSERS_REPORT;
	}
